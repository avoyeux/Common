...
class ArrayManipulation:
    ...
    @staticmethod
    def downsampling(array2D: np.ndarray, downsampling_size: tuple[int, ...], return_npndarray: bool = True) -> np.ndarray | Image.Image:
        """
        ...
        Args:
            ...
            return_npndarray (bool, optional): deciding to return a np.ndarray or an Image.Image. Defaults to True.
        ...
        if return_npndarray: return np.array(array2D)
        return array2D